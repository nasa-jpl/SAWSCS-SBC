...
mp.lambda0 = 633e-9;    %--Central wavelength of the whole spectral bandpass [meters]
...
mp.d_dm1_dm2 = 100.0e0; %0.2;   % distance between DM1 and DM2 [meters]                     d1 --> d2 separation
...
mp.P1.D = 2; %7.989; %--meters, circumscribed. The segment size is 0.955 m, flat-to-flat, and the gaps are 6 mm. %--telescope diameter [meters]. Used only for converting milliarcseconds to lambda0/D or vice-versa.
