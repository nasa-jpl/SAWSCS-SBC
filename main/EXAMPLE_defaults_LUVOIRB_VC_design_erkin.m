...
mp.ctrl.log10regVec = -3:1:-1;          %--log10 of the regularization exponents (often called Beta values)
...
mp.Fend.FOV = 11; %30; %--half-width of the field of view in both dimensions [lambda0/D]

%--Correction and scoring region definition
mp.Fend.corr.Rin  = 2; %2.0;   % inner radius of dark hole correction region [lambda0/D]
mp.Fend.corr.Rout = 22; %26;  % outer radius of dark hole correction region [lambda0/D]
...
mp.P1.D = 4; %7.989; %--meters, circumscribed. The segment size is 0.955 m, flat-to-flat, and the gaps are 6 mm. %--telescope diameter [meters]. Used only for converting milliarcseconds to lambda0/D or vice-versa.
