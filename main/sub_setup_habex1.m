...
mp.Nsbp = 7; %5;            %--Number of sub-bandpasses to divide the whole bandpass into for estimation and control
...
mp.Fend.FOV = 16; %12; %11; %30; %--half-width of the field of view in both dimensions [lambda0/D]

%--Correction and scoring region definition
mp.Fend.corr.Rin  = 3; %2.0;   % inner radius of dark hole correction region [lambda0/D]
...
mp.P1.compact.Nbeam = 512;         % <<<<<<<<<<<<<<, pupil size <<<<<<
%mp.P1.compact.Nbeam = 1024;         % <<<<<<<<<<<<<<, pupil size <<<<<<
...
mp.F3.VortexCharge = 4; %4; %--Charge of the vortex mask
