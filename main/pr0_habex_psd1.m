...
load /home/esidick/Afalco/falco20200916/dat_bb_wfc11_psd/dm1_psd_30mm_cir98_digit_rms_12nm_2to12lamD_chg6_4lam_run1_cbx_itr155 dm1 dm2 tx cbx fom Im beta_value
...
%s2 = sprintf(' with digit-errors:last Cb = %0.3g', cbx(end));
    ...
    %figure(12), clf, semilogy(mx1, cbx(mx1+1), 'ro-', mx2, cbx(mx2+1), 'bs-'), grid, 
        ...
        title('digit-nom, 30mm, 0.98D, rms=12nm, chrg6, [2 12]$\lambda$/D, ','Fontsize',fs,'Interpreter', 'Latex');
