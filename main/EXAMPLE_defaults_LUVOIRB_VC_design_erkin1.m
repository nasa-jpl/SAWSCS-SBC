...
mp.Fend.res = 3; %3; %--Sampling [ pixels per lambda0/D]
mp.Fend.FOV = 12; %11; %30; %--half-width of the field of view in both dimensions [lambda0/D]

%--Correction and scoring region definition
mp.Fend.corr.Rin  = 2; %2.0;   % inner radius of dark hole correction region [lambda0/D]
mp.Fend.corr.Rout = 10; %26;  % outer radius of dark hole correction region [lambda0/D]
...
mp.P1.compact.Nbeam = 500;         % <<<<<<<<<<<<<<, pupil size <<<<<<
