...
%load ~esidick/Afalco/falco20200916/macos/IFopd/target_opd opd_target maskopd
%load ~esidick/Afalco/falco20200916/macos/IFopd/target_opd_1550nm_4if opd_target maskopd
...
%--Re-image to pupil P3
    ...
    %pha_nm = maskopd .* 1e9 * angle(ce) * lambda / 2 / pi;
    pha_nm = 1e9 * atan2(imag(cer), real(cer)) * lambda / 2 / pi;
    %opd1 = 1e9 * atan2(imag(ce), real(ce)) * lambda / 2 / pi;

    %opd_target = pha_nm;
    %save ~esidick/Afalco/falco20200916/macos/IFopd/target_opd opd_target
    %disp('paused'), pause

    %opd = (pha_nm - opd_target*0) .* maskopd;
    opd = pha_nm .* maskopd;

    %save IFopd/dat_test opd opd1 opd_target
    %txt = 'figure(1), clf, imagesc(opd), axis xy image, colormap(jet), colorbar'
   %disp('paused'), pause(10)
    ...
    count_dm1 = [jj ii ma round(delt) round(tsum/60)]

  end
    %dwddm1 = dwddm;
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_full dwddm1 indx maskopd
    %dmx = mp.dm1.V;
    %target_opd = opd;
    %save ~esidick/Afalco/falco20200916/macos/IFopd/test_opd dmx opd
    %save ~esidick/Afalco/falco20200916/macos/IFopd/target_opd target_opd
end

    dwddm1 = dwddm;
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_full dwddm1 indx maskopd
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_full_355nm dwddm1 indx maskopd
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_full_355nm_30nm_bw20_flat dwddm1 indx maskopd
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_500nm_00nm_bw00_gray_gap08 dwddm1 indx maskopd
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_355nm_30nm_bw20_gap08 dwddm1 indx maskopd
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_1500nm_30nm_bw20_gap08 dwddm1 indx maskopd
    %save -v7.3 ~esidick/Afalco/falco20200916/macos/IFopd/dwddm_dm1_nm_over_nm_1500nm_30nm_bw20_gap08_no_ota dwddm1 indx maskopd
    %SAB save -v7.3 ~sab/Projects/6MST/Afalco/falco20200916/macos/IFhex_opd/dwddm_dm1_nm_over_nm_1500nm_opd1_27nm_bw20_gap08 dwddm1 indx maskopd
