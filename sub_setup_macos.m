...
mp.fracBW = 0.2; %0.1;       %--fractional bandwidth of the whole bandpass (Delta lambda / lambda0)
mp.Nsbp = 12; %4;            %--Number of sub-bandpasses to divide the whole bandpass into for estimation and control
