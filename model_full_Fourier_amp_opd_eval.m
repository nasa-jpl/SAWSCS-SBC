...
function [Eout, varargout] = model_full_Fourier_amp_opd_eval(mp, lambda, Ein, normFac)
...
ns = size(mp.wfc.dm1x, 3);

% ---------------------------------------

for jj = 1:ns

    mp.dm1.V = mp.wfc.dm1x(:,:,jj);
    mp.dm2.V = mp.wfc.dm2x(:,:,jj);
